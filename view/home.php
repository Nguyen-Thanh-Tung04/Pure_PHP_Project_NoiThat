                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    ...
                                    <div class="content">
                                        <h5 class="title"><a href="index.php?act=sanphamct">Simple minimal Chair </a>
                                        </h5>
                                        <span class="price">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    ...
                                    <div class="content">
                                        <h5 class="title"><a href="index.php?act=sanphamct">Wooden decorations</a>
                                        </h5>
                                        <span class="price">
                                            <span class="new">$38.50</span>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    ...
                                    <div class="content">
                                        <h5 class="title"><a href="index.php?act=sanphamct">High quality vase
                                                bottle</a></h5>
                                        <span class="price">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    ...
                                    <div class="content">
                                        <h5 class="title"><a href="index.php?act=sanphamct">Living & Bedroom
                                                Chair</a></h5>
                                        <span class="price">
                                            <span class="new">$38.50</span>
                                        </span>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12 mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                <a href="index.php?act=sanphamct" class="banner-3">
